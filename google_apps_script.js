/**
 * =========================================================================
 * GOOGLE APPS SCRIPT - LEAD COLLECTION BACKEND FOR WEBSITES
 * =========================================================================
 * 
 * Hướng dẫn sử dụng:
 ...
 *    (tìm trên URL bảng tính: https://docs.google.com/spreadsheets/d/[ID_BẢNG_TÍNH]/edit).
...
function doPost(e) {
  try {
    ...
    return ContentService.createTextOutput(JSON.stringify({ "result": "success", "message": "Lead appended successfully" }))
